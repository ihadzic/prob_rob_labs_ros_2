        ...
        actions.append(
            Node(
                ...
                parameters=[
                    ...
                    {'actuation_noise_linear_std': 0.005},
                    {'actuation_noise_angular_std': 0.02},
                    {'idle_jitter_linear_std': 0.008},
                    {'idle_jitter_angular_std': 0.06},
                    {'idle_deadband_linear': 0.02},
                    {'idle_deadband_angular': 0.04},
                ],
                output='screen',
            )
        )
